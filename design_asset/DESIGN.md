...
- **Line height:** 0.90–1.50 (tighter at display sizes, 1.5 for body rhythm)
- **Letter spacing:** -0.02em by default, matching the current slide deck output
...
| body | 14px | 1.5 | -0.02em | `--text-body` |
...
폰트, 자간, 줄간격 옵션은 `typography-options.json`에도 별도로 정리되어 있다. 새 composition을 만들 때는 아래 기본값을 우선한다.

- Primary font: `halyard-display-variable`
- Korean fallback: `Paperlogy`
- Default letter spacing: `-0.02em`
- Display tight letter spacing option: `-0.03em`
- Extra tight display option: `-0.05em`
- Dark background compensation option: `0.01em`
- Display line-height: `0.9`
- Heading line-height options: `1`, `1.09`, `1.15`
- Body line-height options: `1.2`, `1.5`, `1.6`
