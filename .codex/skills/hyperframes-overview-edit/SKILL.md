...
`.header-right` 안 `<button class="aim-btn">` 직전에 Edit 버튼과 되돌리기 버튼을 추가한다:

```html
<button class="history-btn" id="nav-undo" title="Undo: Ctrl+Z">↶</button>
<button class="history-btn" id="nav-redo" title="Redo: Ctrl+Y / Ctrl+Shift+Z">↷</button>
